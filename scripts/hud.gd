...
func _ready() -> void:
	...
	_health = _label(42, Color(0.95, 0.18, 0.1), HORIZONTAL_ALIGNMENT_LEFT)
	...
	_armor = _label(28, Color(0.95, 0.72, 0.18), HORIZONTAL_ALIGNMENT_LEFT)
	...
	_ammo = _label(42, Color(1.0, 0.48, 0.12), HORIZONTAL_ALIGNMENT_RIGHT)
